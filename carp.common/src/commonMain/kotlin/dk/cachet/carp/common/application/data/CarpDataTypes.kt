...
object CarpDataTypes : DataTypeMetaDataList()
{
     ...
     */
    val FREE_FORM_TEXT = add( FREE_FORM_TEXT_TYPE_NAME, "Application-specific data" )
     ...
     */
    val GEOLOCATION = add( GEOLOCATION_TYPE_NAME, "Geolocation" )
     ...
     */
    val STEP_COUNT = add( STEP_COUNT_TYPE_NAME, "Step count" )
     ...
     */
    val ECG = add( ECG_TYPE_NAME, "Electrocardiography (ECG)" )
     ...
     */
    val HEART_RATE = add( HEART_RATE_TYPE_NAME, "Heart rate" )
     ...
     */
    val RR_INTERVAL = add( RR_INTERVAL_TYPE_NAME, "R-R interval" )
     ...
     */
    val SENSOR_SKIN_CONTACT = add( SENSOR_SKIN_CONTACT_TYPE_NAME, "Sensor skin contact" )

    internal const val ACCELERATION_TYPE_NAME = "$CARP_NAMESPACE.acceleration"
    /**
     * Acceleration along perpendicular x, y, and z axes.
     */
    val ACCELERATION = add( ACCELERATION_TYPE_NAME, "Accelerometry" )
}
