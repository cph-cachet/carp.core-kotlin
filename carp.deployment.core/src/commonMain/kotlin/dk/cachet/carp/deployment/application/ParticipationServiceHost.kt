 ...
 */
class ParticipationServiceHost( private val repository: DeploymentRepository, private val accountService: AccountService ) : ParticipationService
{
    /**
    ...
    {
        val studyDeployment = repository.getStudyDeploymentOrThrowBy( studyDeploymentId )
