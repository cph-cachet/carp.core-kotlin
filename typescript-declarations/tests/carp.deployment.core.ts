...
import DeviceInvitation = dk.cachet.carp.deployment.domain.users.ActiveParticipationInvitation.DeviceInvitation
...
describe( "carp.deployment.core", () => {
    it( "verify module declarations", async () => {
        ...
        const instances = [
            ...
            new DeviceInvitation( "test", false ),
            [ "DeviceInvitation$Companion", DeviceInvitation.Companion ],
